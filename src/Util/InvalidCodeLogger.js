...
/**
 * logger for invalid code which can not be parsed with esdocs.
 */
class InvalidCodeLogger {
  ...
  showFile(filePath, error) {
    ...
    console.log('[31mwarning: could not parse the following code. if you want to use ECMAScript proposals, see https://esdocs.org/manual/feature.html#ecmascript-proposal[32m');
    console.log(filePath);
    console.log(`${targetLines.join('\n')}[0m`);
